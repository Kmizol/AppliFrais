...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 22 jan. 2019 à 08:42
...
--
-- Base de données :  `projet_appli-frais`
--
...
('adm', 'Millet', 'Vincent', 'kmizol910', 'hemleghk91', '12 rue pablo picasso', '91000', 'Evry', '1998-10-03'),
('c01', 'Veaux', 'Lou', 'lveaux', 'azer3', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21'),
('c02', 'Andrer', 'daniel', 'dandrer', 'oppg5', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23'),
('c03', 'Bepto', 'Christian', 'cbepto', 'gmhxd', '1 rue Peranud', '46250', 'Montcuq', '1995-01-12'),
('c04', 'Tussain', 'Louise', 'ltussain', 'ktp3s', '22 rue des Ternes', '46123', 'Gramat', '2000-05-01');
...
CREATE TABLE IF NOT EXISTS `document` (
  ...
  `NomJustificatif` varchar(255) DEFAULT NULL,
...
(1, 'ETP', 'C:\\Users\\mille\\OneDrive\\Images', 'a131', 'Réparation matériel', 109.99);
...
('a131', '10', 2, '500.00', '2018-11-27', 'VA'),
('adm', '6', 1, '1000.00', '2018-09-25', 'CR'),
('c3', '5', 1, '120.00', '2019-01-08', 'CR');
...
CREATE TABLE IF NOT EXISTS `lignefraishorsforfait` (
  ...
  PRIMARY KEY (`id`),
  KEY `idVisiteur` (`idVisiteur`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
